...
// user is the one whose profile we are currenlt looking
...
const handleFollowUnfollow = async () =>{
	...
	try {
		...
		if(following){
			...
			user.followers.pop();// removing the followed user from followers so that we can easily update the count of followers
		}else{
